...
BASE_DIR = 'hand_data'
HAND_CLASSES = ['Fist', 'Thumbs Up', 'Peace Sign']
OBJ_CLASSES = {0: ["Person", (204, 0, 0)]}  # Red for "Person"

# Initialize YOLO model and Kinect
model = YOLO("C:/path/to/your/best.pt")
...
def save_frame(frame, save_path, index):
...
def process_and_save(frame, x1, y1, x2, y2, save_path, index):
    ...
    save_frame(zoomed_aoi, save_path, index)
    return index + 1
